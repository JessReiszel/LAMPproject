...
--
-- Temporary table structure for view `equipmentsched`
--

DROP TABLE IF EXISTS `equipmentsched`;
/*!50001 DROP VIEW IF EXISTS `equipmentsched`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `equipmentsched` AS SELECT 
 1 AS `iid`,
 1 AS `itemname`,
 1 AS `vname`,
 1 AS `eventdate`*/;
...
INSERT INTO `event` VALUES (001000,'Sam\'s Bat Mitzvah',006,'2018-03-17'),(001001,'Jake and Tristen\'s B\'Nai Mitzvah',002,'2018-03-18'),(001002,'Jacklyn and Jason\'s Wedding',008,'2018-03-25'),(001003,'Brandon\'s Bar Mitzvah',003,'2018-03-23'),(001004,'Bob\'s Bar Mitzvah',007,'2018-03-29'),(001041,'Tom & Jess\' Wedding',008,'2018-03-31');
/*!40000 ALTER TABLE `event` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary table structure for view `eventdatesonly`
--

DROP TABLE IF EXISTS `eventdatesonly`;
/*!50001 DROP VIEW IF EXISTS `eventdatesonly`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `eventdatesonly` AS SELECT 
 1 AS `eventdate`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary table structure for view `itemsonevents`
--

DROP TABLE IF EXISTS `itemsonevents`;
/*!50001 DROP VIEW IF EXISTS `itemsonevents`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `itemsonevents` AS SELECT 
 1 AS `eventid`,
 1 AS `eventname`,
 1 AS `itemname`*/;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `request` (
  ...
  `message` text,
  `requestid` int(4) unsigned zerofill NOT NULL AUTO_INCREMENT,
...
INSERT INTO `request` VALUES ('sampleemail@gmail.com','Zoe Erikson','Wedding','04-31-18','Hi, I wanted to meet with someone at your company to plan a Wedding. I am interested in package 4',0006),('test2@yahoo.com','Jimminy Cricket','Bar Mitzvah','04-15-18','Sample message.............gdskdsfmdlfdsfsdsadsadsagfdsafgdaf',0010),('','','','','',0011),('','','','','',0012),('','','','','',0013),('test123@gmail.com','Amanda Jones','Graduation','05-20-18','fmsakmfkdsjfnmkldkldsfmsls',0014);
...
--
-- Final view structure for view `equipmentsched`
--
...
/*!50001 VIEW `equipmentsched` AS select `i`.`iid` AS `iid`,`ii`.`itemname` AS `itemname`,`v`.`vname` AS `vname`,`e`.`eventdate` AS `eventdate` from ((((`inventory` `i` join `item_info` `ii`) join `venue` `v`) join `event` `e`) join `inven_checkout` `ic`) where ((`i`.`iid` = `ic`.`iid`) and (`i`.`itype` = `ii`.`itemid`) and (`ic`.`eventid` = `e`.`eventid`) and (`e`.`eventvenue` = `v`.`vid`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `eventdatesonly`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `eventdatesonly` AS select `event`.`eventdate` AS `eventdate` from `event` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `itemsonevents`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `itemsonevents` AS select `e`.`eventid` AS `eventid`,`e`.`eventname` AS `eventname`,`ii`.`itemname` AS `itemname` from ((((`inven_checkout` `ic` join `inventory` `i`) join `item_info` `ii`) join `event` `e`) join `venue` `v`) where ((`v`.`vid` = `e`.`eventvenue`) and (`e`.`eventid` = `ic`.`eventid`) and (`ic`.`iid` = `i`.`iid`) and (`i`.`itype` = `ii`.`itemid`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2018-03-23  3:21:05
